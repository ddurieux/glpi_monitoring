...
CREATE TABLE `glpi_plugin_monitoring_configs` (
  ...
  `phppath` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `glpi_plugin_monitoring_configs` VALUES (1,NULL,NULL,'[\"0\"]','0.83+1.0',30);
...
--
-- Dumping data for table `glpi_plugin_monitoring_displayviews`
--

LOCK TABLES `glpi_plugin_monitoring_displayviews` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_displayviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_displayviews` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_displayviews_items`
--

LOCK TABLES `glpi_plugin_monitoring_displayviews_items` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_displayviews_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_displayviews_items` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `glpi_plugin_monitoring_hosts` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_hosts` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_hosts` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `glpi_plugin_monitoring_logs` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_networkports`
--

LOCK TABLES `glpi_plugin_monitoring_networkports` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_networkports` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_networkports` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `glpi_plugin_monitoring_notificationcommands` VALUES (1,1,'Host : notify by mail','notify-host-by-email','$PLUGINSDIR$/sendmailhost.pl \"$NOTIFICATIONTYPE$\" \"$HOSTNAME$\" \"$HOSTSTATE$\" \"$HOSTADDRESS$\" \"$HOSTOUTPUT$\" \"$SHORTDATETIME$\" \"$CONTACTEMAIL$\"'),(2,1,'Service : notify by mail (perl)','notify-service-by-email-perl','$PLUGINSDIR$/sendmailservices.pl \"$NOTIFICATIONTYPE$\" \"$SERVICEDESC$\" \"$HOSTALIAS$\" \"$HOSTADDRESS$\" \"$SERVICESTATE$\" \"$SHORTDATETIME$\" \"$SERVICEOUTPUT$\" \"$CONTACTEMAIL$\" \"$SERVICENOTESURL$\"'),(3,1,'Service : notify by mail (python)','notify-service-by-email-py','$PLUGINSDIR$/sendmailservices.py -s \"$SERVICEDESC$\" -n \"$SERVICESTATE$\" -H \"$HOSTALIAS$\" -a \"$HOSTADDRESS$\" -i \"$SHORTDATETIME$\" -o \"$SERVICEOUTPUT$\" -t \"$CONTACTEMAIL$\" -r \"$SERVICESTATE$\"');
...
LOCK TABLES `glpi_plugin_monitoring_profiles` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_profiles` DISABLE KEYS */;
INSERT INTO `glpi_plugin_monitoring_profiles` VALUES (4,'w','w','w','w','r','w','w','w','w','w');
/*!40000 ALTER TABLE `glpi_plugin_monitoring_profiles` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `glpi_plugin_monitoring_realms` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_realms` DISABLE KEYS */;
INSERT INTO `glpi_plugin_monitoring_realms` VALUES (1,'All',NULL,NULL);
/*!40000 ALTER TABLE `glpi_plugin_monitoring_realms` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_servicegraphs`
--

LOCK TABLES `glpi_plugin_monitoring_servicegraphs` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_servicegraphs` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_servicegraphs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_unavaibilities`
--

LOCK TABLES `glpi_plugin_monitoring_unavaibilities` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_unavaibilities` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_unavaibilities` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_weathermaplinks`
--

LOCK TABLES `glpi_plugin_monitoring_weathermaplinks` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermaplinks` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermaplinks` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_weathermapnodes`
--

LOCK TABLES `glpi_plugin_monitoring_weathermapnodes` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermapnodes` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermapnodes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `glpi_plugin_monitoring_weathermaps`
--

LOCK TABLES `glpi_plugin_monitoring_weathermaps` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermaps` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_monitoring_weathermaps` ENABLE KEYS */;
UNLOCK TABLES;
