...
if (!defined('GLPI_ROOT')) {   
   ...
   $dir = GLPI_ROOT."/files/_plugins/monitoring";
   $objects = scandir($dir);
...
//require_once 'GLPIInstall/AllTest.php';
//require_once 'MonitoringInstall/AllTest.php';
//require_once 'GLPIlogs/AllTest.php';
//require_once 'ManageRessources/AllTest.php';
