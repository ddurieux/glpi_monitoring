...
class PluginMonitoringShinken extends CommonDBTM {
   ...
   function generateContactsCfg() {
      ...
      foreach ($a_listmcontacts as $data) {
         ...
         $config .= "       service_notification_commands  ".$pluginMonitoringNotificationcommand->fields['command_name']."\n";
            $pluginMonitoringNotificationcommand->getFromDB($data['host_notification_commands']);
         $config .= "       host_notification_commands     ".$pluginMonitoringNotificationcommand->fields['command_name']."\n";
