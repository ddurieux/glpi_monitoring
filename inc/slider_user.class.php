...
class PluginMonitoringSlider_User extends CommonDBRelation {
   ...
   **/
   static function getUsers($reminders_id) {
      ...
      $users = array();
      $query = "SELECT `glpi_plugin_monitoring_sliders_users`.*
                FROM `glpi_plugin_monitoring_sliders_users`
                WHERE `pluginmonitoringsliders_id` = '$reminders_id'";
